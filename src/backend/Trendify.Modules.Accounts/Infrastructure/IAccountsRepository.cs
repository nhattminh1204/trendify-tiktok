...
public interface IAccountsRepository
{
    ...
    Task RevokeAllUserRefreshTokensAsync(Guid userId, CancellationToken ct);
    Task<List<SocialAccount>> GetSocialAccountsAsync(Guid tenantId, CancellationToken ct);
    Task<SocialAccount?> FindSocialAccountByIdAsync(Guid tenantId, Guid id, CancellationToken ct);
